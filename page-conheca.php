						...
						<ul class="video-row">
							...
							<?php #specific video category query
								$et_recent_videos_query = new WP_Query( apply_filters( 'et_recent_videos_args', array(
									'category__and' => array( $introdutoria, $video1 ),
									'tax_query' => array(
										array(
								...
								if ( $et_recent_videos_query->have_posts() ) :
									...
									<h4><?php the_title() ?></h4>
										...
										<a href="<?php echo the_permalink(); ?>" class="et-recent-video-play"></a>
									</li>
										<?php
								...
								<?php #specific video category query
								$et_recent_videos_query = new WP_Query( apply_filters( 'et_recent_videos_args', array(
									'category__and' => array( $introdutoria, $video2 ),
									'tax_query' => array(
										array(
											'taxonomy' => 'post_format',
											'field' => 'slug',
								...
								<?php #specific video category query
								$et_recent_videos_query = new WP_Query( apply_filters( 'et_recent_videos_args', array(
									'category__and' => array( $introdutoria, $video3 ),
									'tax_query' => array(
										array(
											'taxonomy' => 'post_format',
											'field' => 'slug',
