...
function et_nexus_load_scripts_styles(){
	...
	wp_localize_script( 'nexus-custom-script', 'et_custom', array(
		...
		'mobile_nav_text' => esc_html__( 'Menu', 'Nexus' ),
...
function et_add_mobile_navigation(){
	...
	echo '<div id="et_mobile_nav_menu">' . '<a href="#" class="mobile_nav closed">' . esc_html__( 'Menu', 'Nexus' ) . '<span class="et_mobile_arrow"></span>' . '</a>' . '</div>';
...
function get_excerpt($count){
  ...
  $excerpt = $excerpt.'... <a href="'.$permalink.'">Continue lendo</a>';
  return $excerpt;
}


/**----------- atualização 2014-12-16 - navigation ----------*/
